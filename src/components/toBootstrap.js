...
function addClass(oneElement){
    switch(oneElement.tagName.toLowerCase()){
        case "h1":
            ...
            break;
        case "h2":
            oneElement.classList.add("display-4", "border-bottom", "border-success", "border-3", "mt-5");
            break;
        case "h3":
            oneElement.classList.add("display-5", "border-bottom", "border-success", "border-3");
            break;
        case "b":
        case "strong":
            ...
            break;
        case "pre"://コードブロック
            oneElement.classList.add("bg-dark", "text-white", "p-2", "m-2", "border", "rounded-3", "mt-3", "mb-3");
            break;
        case "ul":
        case "ol":
            oneElement.classList.add("list-group", "list-group-flush", "list-group-numbered", "p-2", "m-2");
            break;
        case "li":
            oneElement.classList.add("list-group-item", "list-group-item-primary", "font-weight-bold");
            break;
        case "a":
